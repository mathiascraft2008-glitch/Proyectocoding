            ...
            <div class="matches">
                ...
                <div class="match">
                    <div class="match__content">
                        ...
                        <input type="hidden" name="action" value="actualizarEmparejamientoLiga">
                        <?php }else{ ?> 
                            <input type="hidden" name="action" value="actualizarEmparejamientoSuizo">
                        <?php } ?>   
                        ...
                        <?php } ?>
                                ...
                                <?php if ($torneo->getFormato()=="liga" || $torneo->getFormato()=="suizo" ) { ?>
                                <label>Ganador:</label>
                                    <select name="ganador" required>
                                        <option value="<?php echo $partido->getCompetidor1(); ?>">
                                            <?php echo $nombres[$partido->getCompetidor1()]; ?>
